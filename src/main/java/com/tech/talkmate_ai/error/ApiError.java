...
public record ApiError(
        ...
        String message,
        Instant timeStamp,
        @JsonInclude(JsonInclude.Include.NON_NULL) List<ApiFieldError> errors  // if the only present when errors not null other wise not showing errors parameter in json
) {
